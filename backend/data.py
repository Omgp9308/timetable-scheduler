...
def add_faculty(name, expertise):
    ...
    # The expertise is expected to be a list of subject IDs, e.g., ['CS101', 'MA201']
    new_faculty = Faculty(name=name, expertise=expertise)
...
def add_batch(name, strength, subjects):
    ...
    # The subjects are expected to be a list of subject IDs, e.g., ['CS101', 'PH102']
    new_batch = Batch(name=name, strength=strength, subjects=subjects)
